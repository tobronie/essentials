...
class UploadSKTMService {
  Future<void> sktm(String id, File selectedDocument, BuildContext context) async {
    String url = 'https://essentials.my.id/update_ad_sktm.php';
    try {
      var request = http.MultipartRequest('POST', Uri.parse(url));
      request.fields['id_sktm'] = id;
      request.files.add(
