...
class UploadAkteService {
  Future<void> akte(String id, String selectedDocument, BuildContext context) async {
    String url = 'http://10.0.2.2:8080/essentials_api/update_ad_akte.php';
    try {
      var response = await http.post(
        Uri.parse(url),
        body: {
          'id_akte': id,
          'ak_surat_konfirmasi': selectedDocument,
        },
      );
