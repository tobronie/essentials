...
class UploadNikahService {
  Future<void> nikah(String id, File selectedDocument, BuildContext context) async {
    String url = 'https://essentials.my.id/update_ad_nikah.php';
    try {
      var request = http.MultipartRequest('POST', Uri.parse(url));
      request.fields['id_nikah'] = id;
      request.files.add(
