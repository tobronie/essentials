...
class Pejabat_PendudukScreen extends StatefulWidget {
  const Pejabat_PendudukScreen({super.key, required String id});
        ...
        Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                "Jl. Raya Bangilan No 555, Desa Bangilan, Kecamatan Bangilan, Kabupaten Tuban, Jawa Timur, 62364",
                style: GoogleFonts.montserrat(
                  fontSize: 14,
                  fontWeight: FontWeight.w400,
        ...
        Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                "Jl. Kedungmulyo No. 14 Desa Kedungmulyo, Kecamatan Bangilan, Kabupaten Tuban, Provinsi Jawa Timur, 62364.",
                style: GoogleFonts.montserrat(
                  fontSize: 14,
                  fontWeight: FontWeight.w400,
                  fontStyle: FontStyle.italic,
