...
import 'package:essentials/services/update/update_ad_domisili.dart';
...
class Admin_DomisiliScreen extends StatefulWidget {
  final String id;
  const Admin_DomisiliScreen({super.key, required this.id});

  @override
  _Admin_DomisiliScreenState createState() => _Admin_DomisiliScreenState();
}

class _Admin_DomisiliScreenState extends State<Admin_DomisiliScreen> {
  final UploadDomisiliService _UploadDomisiliService = UploadDomisiliService();
    ...
    return Scaffold(
      ...
      body: FutureBuilder<Map<String, dynamic>?>(
        ...
        builder: (context, snapshot) {
          ...
          String JudulPengaduan = domisili["dom_judul"] ?? "Tidak diketahui";
          String suratKonfirmasiData =
              domisili["dom_surat_konfirmasi"] ?? "Tidak diketahui";
          String konfirmasiData = domisili["dom_konfirmasi"] ?? "Tidak diketahui";
  ...
  Widget _document(
    ...
    return GestureDetector(
      onTap: () async {
        ...
        print("ID Domisili yang dikirim: ${widget.id}");
        if (widget.id.isEmpty) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text("ID Domisili tidak valid"),
              backgroundColor: Colors.red,
            ),
          );
          return;
        ...
        DownloadServicesDomisili downloadServicesDomisili = DownloadServicesDomisili();
        String? filePath = await downloadServicesDomisili.downloadAdministrasiDomisili(
            context, widget.id);
