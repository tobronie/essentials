...
class Admin_TanahScreen extends StatefulWidget {
  final String id;
  const Admin_TanahScreen({super.key, required this.id});
    ...
    return Scaffold(
      ...
      body: FutureBuilder<Map<String, dynamic>?>(
        ...
        builder: (context, snapshot) {
          ...
          String JudulPengaduan = tanah["tan_judul"] ?? "Tidak diketahui";
          String suratKonfirmasiData =
              tanah["tan_surat_konfirmasi"] ?? "Tidak diketahui";
  ...
  Widget _document(
    ...
    return GestureDetector(
      onTap: () async {
        ...
        print("ID Tanah yang dikirim: ${widget.id}");
        if (widget.id.isEmpty) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text("ID Tanah tidak valid"),
              backgroundColor: Colors.red,
            ),
          );
          return;
        ...
        String? filePath = await downloadServicesTanah.downloadAdministrasiTanah(
            context, widget.id);
