...
class Admin_KKScreen extends StatefulWidget {
  final String id;
  const Admin_KKScreen({super.key, required this.id});
    ...
    return Scaffold(
      ...
      body: FutureBuilder<Map<String, dynamic>?>(
        ...
        builder: (context, snapshot) {
          ...
          String JudulPengaduan = kk["kk_judul"] ?? "Tidak diketahui";
          String suratKonfirmasiData =
              kk["kk_surat_konfirmasi"] ?? "Tidak diketahui";
  ...
  Widget _document(
    ...
    return GestureDetector(
      onTap: () async {
        ...
        print("ID KK yang dikirim: ${widget.id}");
        if (widget.id.isEmpty) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text("ID KK tidak valid"),
              backgroundColor: Colors.red,
            ),
          );
          return;
        ...
        String? filePath =
            await downloadServicesKK.downloadAdministrasiKK(context, widget.id);
